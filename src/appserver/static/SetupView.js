...
define([
    ...
    return SimpleSplunkView.extend({
        ...
        initialize: function() {
            ...
            // Start the process of the getting the relevant settings
            this.getInputStanza();
        ...
        getAppConfig: function(){
            ...
            // If we already got the config, then return accordingly
        ...
        setConfigured: function(){
            ...
            this.getAppConfig().done(function(model){
                ...
                console.warn("Unable to update app config since the app config could not be loaded");
            });
        ...
        /**
         * Render a page noting that setup is not required.
         */
        renderConfigNotRequired: function(redirect_view){
            this.$el.html('Setup is no longer required this app' + 
                '<div style="margin-top: 16px">' + 
                '<a href="' + redirect_view + '" class="btn btn-primary">Go to app</a>' + 
                '</div>'
            );
        }
    });
